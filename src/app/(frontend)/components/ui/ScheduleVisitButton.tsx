...
const InquiryModal: React.FC = () => {
  ...
  return (
    <>
      {/* Trigger Button */}
      <button
        className="border border-gray-400 text-gray-700 px-4 py-2 rounded-md flex items-center gap-2 text-sm"
        onClick={openModal}
      >
        <Image src={Schedule} alt="Schedule" className="w-6.5 h-7" />
        Schedule A Visit
      </button>
